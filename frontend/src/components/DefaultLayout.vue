    ...
    children: [
      {
        ...
        icon: 'UserIcon',
        children: [
          { name: 'Shirt', href: '#', icon: 'SparklesIcon' },
          { name: 'Pants', href: '#', icon: 'SparklesIcon' },
          { name: 'T-Shirt', href: '#', icon: 'SparklesIcon' },
          { name: 'Hoodie', href: '#', icon: 'SparklesIcon' },
          { name: 'Jacket', href: '#', icon: 'SparklesIcon' },
          { name: 'Suit', href: '#', icon: 'SparklesIcon' },
          { name: 'Underwear', href: '#', icon: 'SparklesIcon' },
          { name: 'Socks', href: '#', icon: 'SparklesIcon' },
        ],
      },
      {
        ...
        icon: 'UserIcon',
        children: [
          { name: 'Dress', href:'#', icon: 'SparklesIcon' },
          { name: 'Skirt', href:'#', icon: 'SparklesIcon' },
          { name: 'Trousers', href:'#', icon: 'SparklesIcon' },
          { name: 'Tops', href:'#', icon: 'SparklesIcon' },
          { name: 'Suit', href:'#', icon: 'SparklesIcon' },
          { name: 'Sweater', href:'#', icon: 'SparklesIcon' },
          { name: 'Shorts', href:'#', icon: 'SparklesIcon' },
          { name: 'Underwear', href:'#', icon: 'SparklesIcon' },
        ],
      },
    ], 
    ...
    children: [
      { name: 'Men Shoes', 
        ...
        children: [
          { name: 'Sneakers', href: '#', icon: 'SparklesIcon' },
          { name: 'Boots', href: '#', icon: 'SparklesIcon' },
          { name: 'Loafers', href: '#', icon: 'SparklesIcon' },
        ] 
      },
      { name: 'Women Shoes', href: '#', icon: 'UserIcon',
        children: [
