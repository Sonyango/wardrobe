...
//         console.log('Image src:', item.imageSrc);
//     });
// });
...
<template>
    <div class="py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center justify-between mb-6">
                ...
                <button @click="openModal" type="button" aria-label="Collection"
            ...
            <div class="space-y-12">
                <div v-for="category in categories" :key="category.name">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <router-link :to="{ name: 'CategoryItems', params: { categoryName: slug(category.name) } }"
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
                        ...
                        <div v-for="item in category.items" :key="item.name"
                            ...
                            <img :src="item.imageSrc" :alt="item.imageAlt"
                                ...
                                @error="console.log('Image failed to load:', item.imageSrc)" />
    ...
    <AddCollectionModal :isOpen="showModal" @close="closeModal" @submit="handleCollectionSubmit" />
