            ...
            <form v-if="!showCodeModal" class="space-y-3" @submit="submitRegistration">
                <div class="flex justify-between">
                    <div>
                        ...
                        <div class="mr-2">
                            <input type="text" v-model="form.fname" name="fname" id="fname" autocomplete="fname"
                    ...
                    <div>
                        ...
                        <div class="ml-2">
                            <input type="text" v-model="form.lname" name="lname" id="lname" autocomplete="lname"
                                required :disabled="loading"
                                class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6" />
                        </div>
                    </div>
                ...
                <div class="flex justify-between">
                    ...
                    <div>
                        ...
                        <div class="ml-2">
                            <input type="tel" v-model="form.phone" name="phone" id="phone" autocomplete="phone" required
                                :disabled="loading"
                                class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6" />
                        </div>
                    </div>
                ...
                <div class="flex justify-between">
                    ...
                    <div>
                        <label for="password-confirmation"
                            class="block text-sm/6 font-medium text-gray-900 ml-3">Confirm Password</label>
                        <div class="ml-2">
                            <input type="password" v-model="form.password_confirmation" name="password_confirmation"
                                id="password_confirmation" autocomplete="new-password" required :disabled="loading"
                                class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6" />
                        </div>
                    </div>
                </div>
            ...
            <div v-if="showCodeModal" class="space-y-3">
                ...
                <form @submit="verifyCode" class="space-y-4">
                    <div>
                        ...
                        <input type="text" v-model="verificationCode" id="code" required :disabled="verifying"
                    ...
                    <div class="flex gap-3">
                        ...
                        <button type="button" @click="resendCode" :disabled="!isResendReady"
